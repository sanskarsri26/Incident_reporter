...
async function main() {
  ...
  const report = {
    ...
    notes: [
      ...
      "Ablation A: with this mock provider and n=16 test cases, enabling runbook retrieval raises top-3 accuracy (withRetrieval 0.875 vs withoutRetrieval 0.75, a 2-of-16-case difference) but does not change top-1 accuracy in this run (0.25 in both arms). Treat both as directional at this sample size, not as a precise effect size -- ablation D (hybrid vs. vector-only retrieval quality itself, a larger and more consistent gap) is the more reliable retrieval signal.",
